...
local info_icon_path = core.formspec_escape("settings_info.png")
local reset_icon_path = core.formspec_escape("settings_reset.png")

local component_funcs =  dofile(core.get_builtin_path() .. "client/settings/components.lua")

local quick_shader_component =  dofile(core.get_builtin_path() .. "client/settings/shader_component.lua")
...
local function get_formspec()
	...
	local fs = {
		...
		"container[", tostring(search_width + 0.25), ", 0.25]",
			"image_button[0,0;0.9,0.9;", core.formspec_escape("search.png"), ";search;]",
			"image_button[0.9,0;0.9,0.9;", core.formspec_escape("clear.png"), ";search_clear;]",
...
local function inputhandler(fields)
...
core.register_on_formspec_input(function(formname, fields)
	if formname ~= "builtin:settings" then return end

	if inputhandler(fields) then
		core.show_formspec("builtin:settings", get_formspec())
	end
